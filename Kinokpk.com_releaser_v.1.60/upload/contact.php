...
if (!$CURUSER){
    ...
    $hash = create_captcha();
    tr("Код с картинки:&nbsp;", "<input type=\"text\" name=\"imagestring\" size=\"36\" value=\"\" /><br />Введите код с картинки внизу.<br /><img src=\"captcha.php?imagehash=$hash\" alt=\"Captcha\" /><br /><font color=\"red\">Код чувствителен к регистру!</font><input type=\"hidden\" name=\"imagehash\" value=\"$hash\" />", 1);
}
?>
    <tr>
