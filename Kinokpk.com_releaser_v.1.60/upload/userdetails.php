...
if ($lastseen == "0000-00-00 00:00:00")
  ...
  $res = mysql_query("SELECT COUNT(*) FROM pollcomments WHERE user = " . $user[id]);
  $pollcomments = mysql_result($res,0);
...
elseif ($user["gender"] == "3") $gender = "<td class=embedded><img src=".$pic_base_url."na.gif alt='Н/Д' style='margin-left: 4pt'></td>";
...
{
$img .= "<a href=\"mywarned.php\"  target=\"_blank\"><img src=\"".$pic_base_url."star_warned.gif\" alt=\"Уровень предупреждений\" title=\"Уровень предупреждений\"></a>";
}
if (!$img)
...
print("<tr><td class=\"rowhead\">Комментариев к опросам</td>");
if ($pollcomments && (($user["class"] >= UC_POWER_USER && $user["id"] == $CURUSER["id"]) || get_user_class() >= UC_MODERATOR))
	print("<td align=\"left\"><a href=\"userhistory.php?action=viewcomments&type=polls&id=$id\">$pollcomments</a></td></tr>\n");
else
	print("<td align=\"left\">$pollcomments</td></tr>\n");
