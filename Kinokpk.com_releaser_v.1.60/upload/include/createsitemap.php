...
$sql = mysql_query("SELECT id,added FROM torrents ORDER BY id DESC LIMIT 300");
...
@file_put_contents(FULL_PATH."/Sitemap.xml",$txt) or stderr("Ошибка!","Невозможно записать файл!");
}
