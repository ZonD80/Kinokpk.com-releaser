...
$SITENAME = "Undefined Title"; // Your site title

$DESCRIPTION = "Undefined Description"; // Meta description
$KEYWORDS = "Undefined Keywords"; // Meta keywords, separate by commas

$autoclean_interval = 900; // autoclean interval (cleanup.php)
$pic_base_url = "./pic/"; // Image folder

define("YOURCOPY","&copy; Undefined Copyright"); // Your custom copyright (will be in footer)
...
$FORUMURL = ""; // Fourm URL (e.g. http://www.forum.ru, WITHOUT / )
$FORUMNAME = ""; // Name of your forum
$fbinname = "Корзина"; // Forum bin name (deleted topics forum)
