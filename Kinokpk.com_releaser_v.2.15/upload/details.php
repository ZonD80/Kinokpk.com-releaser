...
$topicid = $row['topic_id'];
          ...
          if ($row['filename'] != 'nofile') tr($tracker_lang['seeder'], $tracker_lang['seeder_last_seen']." ".mkprettytime($row["lastseed"]) . " ".$tracker_lang['ago']);
