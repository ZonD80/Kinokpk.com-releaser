...
print('<tr><td>Слова на загружаемых картинках:</td><td><input type="text" name="watermark" size="60" value="Kinokpk.com releaser" readonly> Например, Kinokpk.com releaser</td></tr>'); //'.$CACHEARRAY['watermark'].'
...
elseif ($_GET['action'] == 'save'){
       ...
       foreach ($reqparametres as $param) {
         if (!isset($_POST[$param])) stderr($tracker_lang['error'],"Некоторые поля не заполнены ($param)");
