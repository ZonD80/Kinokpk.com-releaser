...
if (mysql_affected_rows() == 0)
	err('Неверный пасскей. Пожалуйста, перекачайте торренс с '.$CACHEARRAY['defaultbaseurl']);
...
$resp = 'd' . benc_str('interval') . 'i' . $CACHEARRAY['announce_interval']*60 . 'e' . benc_str('peers') . (($compact = ($_GET['compact'] == 1)) ? '' : 'l');
