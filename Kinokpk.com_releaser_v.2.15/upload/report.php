...
$msg = sqlesc("Пользователем [b][url=".$CACHEARRAY['defaultbaseurl']."/userdetails.php?id=".$CURUSER["id"]."]".$CURUSER["username"]."[/url][/b] была подана жалоба на торрент [url]".$CACHEARRAY['defaultbaseurl']."/details.php?id=".$torrentid."[/url]\n\nПричина: ".$motive."");
