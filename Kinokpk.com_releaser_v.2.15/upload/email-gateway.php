...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$success = @mail($to, $subject, $message, "From: {$CACHEARRAY['siteemail']}", "-f".$CURUSER['email']);
...
<tr><td class=rowhead>Ваше имя</td><td><input type=text name=from size=80 value=<?=$CURUSER["username"]?> disabled></td></tr>
<tr><td class=rowhead>Ваш e-mail</td><td><input type=text name=from_email size=80 value=<?=$CURUSER["email"]?> disabled></td></tr>
