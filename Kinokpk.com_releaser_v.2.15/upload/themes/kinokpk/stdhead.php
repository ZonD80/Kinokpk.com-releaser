...
<a href="<?=$CACHEARRAY['defaultbaseurl']?>"><img style="border: none" alt="<?=$CACHEARRAY['sitename']?>" title="<?=$CACHEARRAY['sitename']?>" src="./themes/<?=$ss_uri;?>/images/logo.jpg" /></a>
...
<a href="passwordadmin.php">Сменить пароль и мыло</a>
