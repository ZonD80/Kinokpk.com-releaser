...
while (list($tid, $posts, $title, $icon_id, $CACHEARRAY['description'], $starter_name, $last_poster_name, $views) = mysql_fetch_array($result)) {
    $post_text = ($CACHEARRAY['description']) ? "".$title." - ".$CACHEARRAY['description']."" : $title;
