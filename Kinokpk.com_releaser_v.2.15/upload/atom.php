...
//        print_r ($cat);
   ...
   $content = str_replace('</div></div>','',$content);
	...
	$feeds->addItem(new FeedItem($CACHEARRAY['defaultbaseurl']."/details.php?id=$id&amp;hit=1", iconv("CP1251", "UTF-8",$namear[$id]), $CACHEARRAY['defaultbaseurl']."/details.php?id=$id&amp;hit=1", iconv("CP1251", "UTF-8",$content)));
