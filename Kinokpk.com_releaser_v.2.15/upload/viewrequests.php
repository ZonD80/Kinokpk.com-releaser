...
print("<p><a href=". $_SERVER[PHP_SELF] ."?".(isset($_GET['category'])?"category={$_GET['category']}&":"")."sort=" . $_GET[sort] . "&filter=true>".$tracker_lang['hide_filled']."</a></p>\n");
...
list($pagertop, $pagerbottom, $limit) = pager($perpage, $count, $_SERVER["PHP_SELF"] ."?" .(isset($_GET['category'])?"category={$_GET['category']}&":"")."sort=" . $_GET["sort"] . "&" );
