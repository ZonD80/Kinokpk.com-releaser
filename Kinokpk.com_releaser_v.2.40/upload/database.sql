...
INSERT INTO `descr_details` VALUES (47, 5, 3, 'Треклист/Описание', 'Треклист/описание каждого альбома. Советуем скрывать треклисты каждого альбома тегом <b>spoiler</b><br/>Например: [spoiler=Black album (2008)]<br/>1...<br/>2...<br/>[/spoiler].', 'bbcode', 0, 'no', 'yes', '', 'yes', 'no', 'yes');
INSERT INTO `descr_details` VALUES (29, 3, 4, 'Треклист/Описание', 'Треклист (или песни, которые звучали на концерте)', 'bbcode', 0, 'no', 'yes', '', 'yes', 'no', 'yes');
...
INSERT INTO `descr_details` VALUES (42, 4, 3, 'Треклист/Описание', 'Треклист (или песни, которые включены в альбом)', 'bbcode', 0, 'no', 'yes', '', 'yes', 'no', 'yes');
...
INSERT INTO `faq` VALUES (38, 'item', 'Могу ли я раздавать ваши торренты на других трекерах?', 'Да, естественно. Только укажите, что это наш релиз.', 2, 4, 3);
...
INSERT INTO `orbital_blocks` VALUES (16, '', 'Друзья', 'none', 'l', 9, 1, '', '', 0, '0', 'd', 'ihome,');
...
INSERT INTO `orbital_blocks` VALUES (24, '', 'Реклама', '<script type="text/javascript">\r\nvar begun_auto_pad = 121486566;\r\nvar begun_block_id = 121486709;\r\n</script>\r\n<script src="http://autocontext.begun.ru/autocontext2.js" type="text/javascript"></script>', 'r', 2, 0, '', '', 0, '0', 'd', 'all');
...
CREATE TABLE `rules` (
  ...
  `order` int(10) NOT NULL default '0',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=77 DEFAULT CHARSET=cp1251 PACK_KEYS=0 AUTO_INCREMENT=77 ;
...
CREATE TABLE `stylesheets` (
  ...
  PRIMARY KEY  (`id`),
  KEY `uri` (`uri`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=cp1251 PACK_KEYS=0 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=2 ;
...
INSERT INTO `tags` VALUES (27, 2, 'DrumnBass', 0);
...
INSERT INTO `tags` VALUES (103, 2, 'RocknRoll', 0);
