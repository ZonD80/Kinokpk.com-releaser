...
function pageswitcher(page) {
    ...
    $.get("users.php", { ajax: "", page: page, search: "'.base64_encode($search).'", class: "'.$class.'" }, function(data){
    $("#users-table").empty();
...
elseif (!isset($_GET['act'])) {
	...
	while ($arr = mysql_fetch_assoc($res)) {
		...
		if ($arr["gender"] == "1") $gender = "<img src=\"pic/male.gif\" alt=\"Парень\" style=\"margin-left: 4pt\">";
		elseif ($arr["gender"] == "2") $gender = "<img src=\"pic/female.gif\" alt=\"Девушка\" style=\"margin-left: 4pt\">";
