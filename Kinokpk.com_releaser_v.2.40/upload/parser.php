...
<table width="100%" border="1" cellspacing="2" cellpadding="2">
	...
	if (!isset($_GET['id']) && !isset($_GET['filmname'])) print('<tr><td>Введите название фильма:</td><td><form method="get"><input type="text" name="filmname"><br />Год фильма:<input type="text" name="filmyear" size="5">
