...
while ($row = mysql_fetch_array($sql)) {
	...
	print("<tr><td><strong>$id</strong> </td> <td><strong>$sort</strong></td> <td><strong>$name</strong></td> <td><img src='pic/cats/$img' border='0' /></td><td><div align='center'><a href='browse.php?cat=$id'><img src='pic/viewnfo.gif' border='0' class=special /></a></div></td> <td><a href='category.php?editid=$id&name=$name&img=$img&sort=$sort'><div align='center'><img src='pic/multipage.gif' border='0' class=special /></a></div></td> <td><div align='center'><a onclick=\"return confirm('Вы уверены?');\" href='category.php?delid=$id'><img src='pic/warned2.gif' border='0' class=special align='center' /></a></div></td></tr>");
