...
window.opener.document.forms[form].elements[text].value = window.opener.document.forms[form].elements[text].value+" [img]<?=$CACHEARRAY['defaultbaseurl']?>/pic/stamp/"+smile+"[/img] ";
window.opener.document.forms[form].elements[text].focus();
}
</script>
<title><?=$CACHEARRAY['sitename']?> :: <?=$tracker_lang['stamps']?></title>
<link rel="stylesheet" href="./themes/<?=$ss_uri."/".$ss_uri?>.css"
	type="text/css" />
</head>

<table width="100%" border="1" cellspacing="2" cellpadding="2">
	<h2><?=$tracker_lang['stamps_seals'], $CACHEARRAY['defaultbaseurl']?></h2>
	<tr align="center">
	<?
	$ctr=0;
...
<div align="center">[<a href="javascript:window.close()"><?=$tracker_lang['close_window']?></a>]
</div>