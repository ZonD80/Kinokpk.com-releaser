...
<table class=main width=100% border=0 cellspacing=0 cellpadding=0>
	<tr>
		...
		<table cellspacing=0 cellpadding=5>
			...
			<tr>
				<td align="center"><?textbbcode("message","msg",$body);?> <!--<textarea name=msg cols=80 rows=15><?=$body?></textarea>-->
				</td>
			</tr>
			<tr>
				<td colspan=2>
