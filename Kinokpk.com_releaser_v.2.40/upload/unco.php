...
if( mysql_num_rows($res) != 0 )
{
	...
	while( $row = mysql_fetch_assoc($res) )
	{
		...
		print'<td align=center><select name=confirm><option value=pending>'.$tracker_lang['not_confirmed'].'</option><option value=confirmed>'.$tracker_lang['confirmed'].'</option></select></td>';
