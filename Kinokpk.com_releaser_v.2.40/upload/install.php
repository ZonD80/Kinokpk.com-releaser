...
if (!isset($_GET['step'])) {
	print "Вас приветствует скрипт установки Kinokpk.com releaser 2.40. Следуйте инструкциям и все будет нормально.<hr/>";
	print "Greetings for you from Kinokpk.com releaser 2.40 installation script. Follow the instructions and all will be OK.<hr/>";
...
elseif ($_GET['step'] == 5) {
	print "Установка Kinokpk.com releaser 2.40 успешно завершена! НЕ ЗАБЫВАЙТЕ УДАЛИТЬ ЭТОТ ФАЙЛ И database.sql С ВАШЕГО СЕРВЕРА, А ТАКЖЕ ПОСТАВИТЬ CHMOD 644 НА ФАЙЛ include/secrets.php<hr/>";
	print "You have successfully installed Kinokpk.com releaser 2.40! DO NOT FORGET TO DELETE THIS FILE AND database.sql FROM YOUR SERVER, ALSO SET CHMOD TO 644 ON include/sectets.php<hr/>";
