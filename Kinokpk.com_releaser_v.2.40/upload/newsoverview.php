...
"<td class=\"colhead\">Добавлена</td><td class=\"colhead\">Заглавие</td><td class=\"colhead\">Содержание</td></tr>\n");
	...
	$subres = mysql_query("SELECT COUNT(*) FROM newscomments WHERE news = ".(int) $_GET['id']);
	...
	if (!$count) {
		...
		list($pagertop, $pagerbottom, $limit) = pager($limited, $count, "newsoverview.php?id=".(int) $_GET['id']."&", array(lastpagedefault => 1));
