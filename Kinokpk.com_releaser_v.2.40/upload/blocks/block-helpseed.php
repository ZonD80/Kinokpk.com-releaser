...
if (mysql_num_rows($res) > 0) {
	while ($arr = mysql_fetch_assoc($res)) {
		...
		$content .= "<small><b><a href=\"details.php?id=".$arr['id']."\" alt=\"".$arr['name']."\" title=\"".$arr['name']."\">".$torrname."</a></b><font color=\"#0099FF\"><b> (".sprintf($tracker_lang['new_torrents_stats'], number_format($arr['seeders']), number_format($arr['leechers'])).")</b></font></small><br />\n";
	}
} else
