...
$test = $_POST["test"];
?>
<p><?=$CACHEARRAY['sitename']?> поддерживает большое количество <i>BB
тегов</i> которые вы можете использовать для украшения ваших раздач и
постов.</p>

<form method=post action=?><textarea name=test cols=60 rows=3><? print($test ? htmlspecialchars($test) : "")?></textarea>
<input type=submit value="Проверить этот код!"
	style='height: 23px; margin-left: 5px'></form>
<?
