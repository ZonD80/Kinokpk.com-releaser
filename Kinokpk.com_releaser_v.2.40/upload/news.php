...
if ($action == 'edit')
{
	...
	else
	{
		...
		print("<tr><td>Тема: <input type=text name=subject maxlength=70 size=50 value=\"" . $arr["subject"] . "\"/></td></tr>");
...
print("<tr><td>Тема: <input type=text name=subject maxlength=40 size=50 value=\"" . $arr["subject"] . "\"/></td></tr>");
print("<tr><td style='padding: 0px'>");
