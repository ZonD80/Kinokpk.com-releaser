...
function send(){
   ...
   $("#ajax").append('<div align="center"><img src="pic/loading.gif" border="0"/></div>');
    $.post("mywarned.php", { ajax: "", id: bonus_type }, function(data){
   $("#ajax").empty();
   $("#ajax").append(data);
});
})(jQuery);
...
<table class="embedded" width="100%" border="1" cellspacing="0"
	...
	?>
	<tr align="center">
		<td class="colhead" colspan="3">Мои предупреждения <?=$CURUSER["num_warned"];?>,
		аплоад в наличии <?=mksize($CURUSER["uploaded"]);?></td>
	</tr>
	<tr align="center">
		<td class="colhead">Кол-во предупреждений</td>
		<td class="colhead">Стоимость</td>
