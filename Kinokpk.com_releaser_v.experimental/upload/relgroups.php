...
if (!$id) {
        ...
        <div class="relgroups_name">
            <dl class="clearfix">
                ...
                <dd class="result_name"><a
                    href="<?php print $REL_SEO->make_link('relgroups', 'id', $row['id']); ?>"><?php print makesafe($row['name']) . ($row['private'] ? ' (Приватная)' : ''); ?></a>
                </dd>
    ...
    <div id="relgroups_header" class="relgroups_header">
        <div align="center"><?php print makesafe($row['name']); ?>
            &nbsp;&nbsp;<?php   print(ratearea($row['ratingsum'], $row['id'], 'relgroups', ($I_OWNER ? $row['id'] : 0)) . "");?></div>
    ...
    <div id="relgroups_table_left">
        <div id="boxes_left" class="box_left">
            <div id="box_left" style="margin-top: 9px;">
                <h3 class="box_right_left">
                    <span>Информация о группе</span><?print('<div align="center">' . (((get_privilege('edit_relgroups', false)) || $I_OWNER) ? "<a class=\"box_editor_left\" href=\"#\"></a>" : "") . '</div>');?>
                </h3>
                ...
                <div class="basic_infor_summary_list box_left_page">
                    ...
                    <dl class="infor_left">
                        ...
                        <dd><b><?php print makesafe($row['name']); ?></b>
                            <img style="float:right;padding-right:20px;" src="<?php print $row['image']; ?>"
                                 title="<?php print makesafe($row['name']); ?>"/>
                        </dd>
            ...
            if ($rgusers) {
                $rgusers = implode(', ', $rgusers);
                ?>
                <div id="box_left" class="box_left" style="margin-top: 9px;">
                    <h3 class="box_right_left">
                        <span>Участники (последние 10)</span> <?print('<div align="center">' . (((get_privilege('edit_relgroups', false)) || $I_OWNER) ? "<a class=\"box_editor_left\" href=\"#\"></a>" : "") . '</div>');?>
                    </h3>
        ...
        <div id="box_left_wall" class="box_left"
            ...
            <h3 class="box_right_left">
                <span>Комментарии к Группе</span><?php print('<div align="center">' . (((get_privilege('edit_relgroups', false)) || $I_OWNER) ? "<a class=\"box_editor_left\" href=\"#\"></a>" : "") . '</div>');?></a>
            </h3>
            <?php
            $REL_TPL->begin_frame();
