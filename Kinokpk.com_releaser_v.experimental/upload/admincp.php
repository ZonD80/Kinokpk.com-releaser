...
<table width="100%" cellspacing="10" align="center">
    <tr>
        ...
        <td><a
            href="<?=$REL_SEO->make_link('seoadmin');?>"><?=$REL_LANG->_("Human Readable URLs configuration (SEO)");?></a>
        </td>
    </tr>
    <tr>
        <td><a href="<?=$REL_SEO->make_link('blocksadmin');?>"><?=$REL_LANG->_("Blocks administration");?></a></td>
        <td colspan="3"><a
            href="<?=$REL_SEO->make_link('templatesadmin');?>"><?=$REL_LANG->_("Skins administration");?></a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="<?=$REL_SEO->make_link('retrackeradmin');?>"><?=$REL_LANG->_("Retracker administration");?></a>
        </td>
    ...
    <tr>
        ...
        <td colspan="3"><a
            href="<?=$REL_SEO->make_link('reltemplatesadmin');?>"><?=$REL_LANG->_("Release's templates adminsitration");?></a>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3"><a
            href="<?=$REL_SEO->make_link('recountadmin');?>"><?=$REL_LANG->_("Recount/sync database values");?></a></td>
    </tr>
    <tr>
        <td><a
            href="<?=$REL_SEO->make_link('users', 'act', 'users');?>"><?=$REL_LANG->_("View users with rating below 0");?></a>
        </td>
        <td><a href="<?=$REL_SEO->make_link('users', 'act', 'banned');?>"><?=$REL_LANG->_("View disabled users");?></a>
        </td>
    ...
    <tr>
        <td class=embedded><a
            href="<?=$REL_SEO->make_link('usersearch');?>"><?=$REL_LANG->_("Administrative search");?></a></td>
    </tr>
</table>
