            ...
            <div align=center>
                <form method=post name=message
                    ...
                    <table cellspacing=0 cellpadding=5>
                        <tr>
                            <td class="colhead"
                                colspan="2"><?php print $REL_LANG->_('Mass PM for selected classes'); ?></td>
                        </tr>
                        <tr>
                        ...
                        <TD colspan="2"><?php print $REL_LANG->_('Subject'); ?>: <INPUT name="subject" type="text"
                                                                                        size="70"></TD>
                        </TR>
                        <tr>
                            <td align="center"><?print textbbcode("msg", $body);?>
                                <!--<textarea name=msg cols=80 rows=15><?php print $body; ?></textarea>-->
                            </td>
                        </tr>
                        <tr>
                            <td colspan=2>
                                <div align="center"><b><?php print $REL_LANG->_('Sender'); ?>
