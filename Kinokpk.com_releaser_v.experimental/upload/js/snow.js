...
function SnowStorm() {
    ...
    var imagePath = '/pic/snow/'; // relative path to snow images (including trailing slash)
    var flakesMax = 128;
    var flakesMaxActive = 32;
    var vMaxX = 8;
    var vMaxY = 4;
    var usePNG = true;
    var flakeBottom = null;        //null Integer for fixed bottom, 0 or null for "full-screen" snow effect
    var snowStick = false;
