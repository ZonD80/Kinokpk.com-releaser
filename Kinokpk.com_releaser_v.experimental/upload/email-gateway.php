...
<p><font
    class=small><?php print $REL_LANG->_('Attention! Your IP address will be recorded due to security. Please verify that you correctly filled your e-mail if you expecting an answer.'); ?></font>
</p>
<?php $REL_TPL->stdfoot(); ?>