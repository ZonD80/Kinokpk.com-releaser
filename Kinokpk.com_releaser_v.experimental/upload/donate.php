...
<p>Вам необходимо заплатить <?php print $amount; ?> WMZ...</p>
<p><input type="hidden" name="LMI_PAYMENT_AMOUNT" value="<?php print $amount; ?>">
<input type="hidden" name="LMI_PAYMENT_DESC"
	value="Привелегия на TorrentsBook.com"> <input type="hidden"
	name="amount" value="<?php print $amount; ?>"> <input type="hidden" name="mode"
	value="wm"> <input type="hidden" name="id" value="<?php print $CURUSER['id']; ?>">
				...
				<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
					<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="on0" value="Enter your nickname or ID"><span class="pp">VIP account, <b>$20</b></span>
							...
							<input type="hidden" name="os0"	value="userid:<?php print $CURUSER['id']; ?>">
...
платите<br />
3. В случае возникновения различных проблем обращайтесь к <a	href="<?php print $REL_SEO->make_link('staff'); ?>">администрации сайта</a> или по
