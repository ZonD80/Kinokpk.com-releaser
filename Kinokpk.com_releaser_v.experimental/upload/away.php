...
Вы покидаете сайт '.$REL_CONFIG['sitename'].' по внешней ссылке <b>'.iconv("utf8","windows-1251",urldecode($url)).'</b>, предоставленной одним из участников. <br/>
<a href="'.$REL_SEO->make_link('staff').'">Администрация</a> '.$REL_CONFIG['sitename'].' не несет ответственности за содержимое сайта <b>'.iconv("utf8","windows-1251",urldecode($url)).'</b> и настоятельно рекомендует <b>не указывать</b> никаких своих данных, имеющих отношение к '.$REL_CONFIG['sitename'].' (особенно <b>e-mail</b>, <b>пароль</b> и <b>cookies</b>), на сторонних сайтах. <br/><br/>
Кроме того, сайт <b>'.iconv("utf8","windows-1251",urldecode($url)).'</b> может содержать вирусы, трояны и другие вредоносные программы, опасные для Вашего компьютера. <br/>
...
Если Вы еще не передумали, нажмите на <a href="'.$url.'" id="to_go">'.iconv("utf8","windows-1251",urldecode($url)).'</a>. <br/>
