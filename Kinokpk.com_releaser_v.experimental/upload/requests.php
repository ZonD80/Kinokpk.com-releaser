...
<table border=1 width=550 cellspacing=0 cellpadding=5>
    <tr>
        <td class=colhead
            align=left><?php print $REL_LANG->_('Search for releases (to verify, that there is no release you want)');?></td>
    </tr>
    <tr>
        <td align=left>
            <form method="get" action="<?php print $REL_SEO->make_link('browse'); ?>"><input
                type="text" name="search" size="40"
                value="<?php print  htmlspecialchars($searchstr); ?>"/>&nbsp;<?php print $REL_LANG->_('at');?>&nbsp<?php
