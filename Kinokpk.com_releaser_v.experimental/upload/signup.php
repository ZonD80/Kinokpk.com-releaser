...
//stderr($REL_LANG->say_by_key('error'), "Ќаш проект осуществл€етс€ совместно с форумом $REL_CONFIG['forumname'], пройдите регистрацию на нем, а затем просто войдите под своим логином и паролем. „ерез 3 секунды вы будете перенаправлены.");
...
if (!$_POST["agree"]) {
	$REL_TPL->stdhead("ѕравила трекера");
	?>
...
<table cellpadding="4" cellspacing="0" border="0" style="width: 100%"
	...
	<tr>
		...
		<p><strong>ѕравила <?=$REL_CONFIG['sitename']?></strong></p>
		<p>–егистраци€ на трекере абсолютно бесплатна! Ќасто€тельно
		рекомендуем ознакомитьс€ с правилами нашего проекта. ≈сли вы согласны
		со всеми услови€ми, поставьте галочку р€дом с 'я согласен' и нажмите
		'–егистраци€'. ≈сли вы передумали регистрироватьс€, нажмите <a
			href="<?=$REL_CONFIG['defaultbaseurl'];?>">здесь</a>, чтобы вернутьс€
		на главную страницу.</p>
		<p>’от€ модераторы и администраторы, обслуживающие сайт, стараютс€
		удал€ть все оскорбительные и некорректные сообщени€ из трекера, все
		равно все сообщени€ просмотреть невозможно. —ообщени€ отражают точку
		зрени€ только автора, но не администрации трекера, соответственно
		только автор несет ответственность за содержание сообщени€.</p>
		<p>—оглаша€сь с нашими правилами, вы об€зуетесь выполн€ть требовани€
		трекера в целом, а также требовани€ законодательства –‘.</p>
		<p>јдминистраци€ трекера оставл€ет за собой право удал€ть, измен€ть,
...
<p><input class="tableinborder" type="submit" value="–егистраци€"></p>
</div>
</form>
	<?
	$REL_TPL->stdfoot();
