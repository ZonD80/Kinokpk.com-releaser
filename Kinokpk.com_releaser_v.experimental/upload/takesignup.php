...
$ret = $REL_DB->query("INSERT INTO users (username, passhash, secret, editsecret, notifs, emailnotifs, email, confirmed, class, added, last_login, last_access, language, timezone, invitedby, invitedroot,custom_privileges) VALUES (" .
