<ul>
	...
	With the same result '~' can be used to deny, e.g. '~alfiest' in comments search all users with comments, except containing 'alfiest').</li>
	...
	<li>'Active only' - search users which currently connected to tracker, 'Disabled IPs' - only for disconnected users.</li>
	<li>The 'p' columns in the results show partial stats, that is, those
	of the torrents in progress.</li>
	<li>History bar displays comments, forum posts, e.g. it is a link to user history.</li></ul>