...
<div align="left"><img src="pic/pn_inboxnew.gif" alt="<?php print $REL_LANG->_('Unread'); ?>"/>
    ...
    <img src="pic/pn_inbox.gif"
         alt="<?php print $REL_LANG->_('Readed'); ?>"/> <?php print $REL_LANG->say_by_key('mail_read_desc'); ?></div>
<?php    $REL_TPL->stdfoot();
...
<TABLE width="100%" border="0" cellpadding="4" cellspacing="0">
    ...
    <TR>
        <TD class="colhead" colspan="2"><?php print $REL_LANG->_('Subject') ?>: <?php print $subject; ?><span
            class="higo"><a
                ...
                <table class=message cellspacing=0 cellpadding=5>
                    <tr>
                        <td colspan=2 class=colhead><?php print $REL_LANG->_('Receiver');?> <a class=altlink_white
                                                                                               href="<?php print $REL_SEO->make_link('userdetails', 'id', $receiver, 'username', translit($user['username'])); ?>"><?php print $user ["username"]; ?></a>
                        </td>
                    </tr>
                    <TR>
                        <TD colspan="2"><B><?php print $REL_LANG->_('Subject'); ?>:&nbsp;&nbsp;</B> <INPUT
                            name="subject"
                    ...
                    <tr>
                        ...
                        <td align=center><input type=checkbox name='delete' value='1'
                            <?php print $CURUSER ['deletepms'] ? "checked" : ""; ?> /><?php print $REL_LANG->_('Delete message after sending'); ?>
                            <input type=hidden name=origmsg value=<?php print $replyto; ?>/></td>
                        <?php
                    }
                        ?>
                        <td align=center><input type=checkbox name='save' value='1'
                            <?php print $CURUSER ['savepms'] ? "checked" : ""; ?> /><?php print $REL_LANG->_('Save message in "sent" mailbox'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="center"><input type="checkbox" name='archive'
                                                  value='1'/><?php print $REL_LANG->_('Add message to archive after sending'); ?>
                        </td>
                    </tr>
                    <tr>
            ...
            <div align=center>
                <form method=post action=<?php print $_SERVER ['PHP_SELF']; ?> name=message><input
                    ...
                    <table border=1 cellspacing=0 cellpadding=5>
                        <tr>
                            <td class=colhead
                                colspan=2><?php print $REL_LANG->_('Amout of messages to sent: %s', $n_pms); ?></td>
                        </tr>
                        <TR>
                            <TD colspan="2"><B><?php print $REL_LANG->_('Subject'); ?>:&nbsp;&nbsp;</B> <INPUT
                                name="subject"
                        ...
                        <tr>
                            <td colspan="2">
                                <div align="center"><b><?php print $REL_LANG->_('Comment to profile'); ?>
                                    :&nbsp;&nbsp;</b> <input
                        ...
                        <tr>
                            <td>
                                <div align="center"><b><?php print $REL_LANG->_('From'); ?>
                                    :&nbsp;&nbsp;</b> <?php print $CURUSER ['username']; ?>
                                    <input name="sender" type="radio" value="self" checked/> &nbsp;
                                    <?php print $REL_LANG->_('From system'); ?> <input name="sender" type="radio"
                                                                                       value="system"/></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align=center><input type=submit
                                                                value="<?php print $REL_LANG->_('Send'); ?>!"
                                                                class=btn/></td>
                        </tr>
                    </table>
    ...
    <FORM action="<?php print $REL_SEO->make_link('message'); ?>" method="post"><INPUT
        ...
        <TABLE border="0" cellpadding="4" cellspacing="0">
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="to" value="<?php print $REL_LANG->_('Enter username'); ?>"
                           onclick="javascript:$(this).val('');" size="83"></TD>
            </TR>
            <TR>
