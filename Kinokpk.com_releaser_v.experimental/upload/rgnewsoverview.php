...
<div id="relgroups_header" class="relgroups_header">
    <div align="center">Обзор Новости Релиз группы <?php print makesafe($relgroup['name']); ?>
        &nbsp;&nbsp;<?php   print(ratearea($relgroup['ratingsum'], $relgroup['id'], 'relgroups', ($I_OWNER ? $relgroup['id'] : 0)) . "");?></div>
    ...
    <div id="boxes_left" class="box_left">
        ...
        <div id="box_left" style="margin-top: 9px;">
            <h3 class="box_right_left"><span>Обсуждаем: <?php print $rgnews['subject']; ?></span>
                <?print('<div align="center">' . (((get_privilege('edit_relgroups', false)) || $I_OWNER) ? "<a class=\"box_editor_left\" title=" . $REL_LANG->say_by_key('edit') . " href=\"" . $REL_SEO->make_link('rgnews', 'action', 'edit', 'id', $relgroup['id'], 'newsid', $rgnewsid, 'returnto', $REL_SEO->make_link('rgnews', 'id', $rgnewsid)) . "\"></a>" : "") . '</div>');?>
            </h3>
