...
if (!$count) {
    ...
    <a href=\"{$REL_SEO->make_link('details','id',$row['id'],'name',translit($row['name']))}\">{$row['name']}</a>
  </td>
</tr>
...
<tr valign=\"top\" >
  <td align=\"center\" width=\"160\" style=\"padding:10px 10px;\">
    <a href=\"{$REL_SEO->make_link('details','id',$row['id'],'name',translit($row['name']))}\"><img border=\"0\" src=\"$image\" width=\"170\" class=\"corners\" height=\"200\" title=\"{$row['name']}\" alt=\"{$row['name']}\"/></a>
  </td>
  ...
  <td style=\"padding-top:10px;\">
    ...
    <br>
    <br>
     <div align=\"right\"> [ <a href=\"{$REL_SEO->make_link('details','id',$row['id'],'name',translit($row['name']))}\"><b>{$REL_LANG->say_by_key('more')} </b></a>]  <br></div>  </td>";
        ++$nc;
        if ($nc == 2) {
            $nc = 1;
            $content .= "</tr>";
