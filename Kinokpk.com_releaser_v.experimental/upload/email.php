...
<form method=post name=message
	action="<?php print $REL_SEO->make_link('takeemail'); ?>">
<table>
	<TR>
		<TD colspan="2" style="border: 0">&nbsp;<?php print $REL_LANG->say_by_key('subject'); ?>
		<INPUT name="subject" type="text" size="70"></TD>
	</TR>
	<tr>
		<td align="center" style="border: 0"><?php print textbbcode("msg",$body); ?>
		</td>
	</tr>
	<tr>
		<td colspan=2 align=center style="border: 0"><input type=submit
			value="<?php print $REL_LANG->say_by_key('submit'); ?>" class=btn></td>
	</tr>
</table>
</form>
<?php
