...
$REL_CONFIG['sitename'] = htmlspecialchars(iconv("windows-1251","utf-8",$REL_CONFIG['sitename']));
...
$feeds->setDescription($REL_CONFIG['sitename'].iconv("windows-1251","utf-8"," - новости RSS 2.0"));
...
if (!$items)
$feeds->addItem(new FeedItem($REL_CONFIG['defaultbaseurl'], iconv("windows-1251","utf-8",$REL_LANG->say_by_key('error')), $REL_CONFIG['defaultbaseurl'], iconv("windows-1251","utf-8",$REL_LANG->say_by_key('no_torrents'))));
