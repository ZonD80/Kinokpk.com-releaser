...
else
{
	...
	<td class=colhead><a href=\"stats.php?uporder=torrents&amp;catorder=$catorder\" class=colheadlink>Торрентов</a></td>\n
	<td class=colhead>Завершено</td>\n
	<td class=colhead><a href=\"stats.php?uporder=peers&amp;catorder=$catorder\" class=colheadlink>Пиров</a></td>\n
	<td class=colhead>Завершено</td>\n
	</tr>\n");
