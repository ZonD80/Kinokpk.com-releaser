...
elseif ($_GET["action"] == "edit" && isset($_GET[id])) {
	...
	while ($arr = mysql_fetch_array($res, MYSQL_BOTH)) {
		...
		if ($arr[type] == "item") {
			...
			print("<tr><td style=\"vertical-align: top;\">Вопрос:</td><td><textarea id=mce rows=15 cols=80 name=\"rule\">$arr[rule]</textarea></td></tr>\n");
...
elseif ($_GET["action"] == "delete" && isset($_GET["id"])) {
	...
	elseif ($_GET[action] == "additem" && $_GET["inid"]) {
		...
		print("<tr><td style=\"vertical-align: top;\">Вопрос:</td><td><textarea id=mce rows=15 cols=80 name=\"rule\"></textarea></td></tr>\n");
	...
	else safe_redirect(" rulesadmin.php");
