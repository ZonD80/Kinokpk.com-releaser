...
implode(",", array_map("sqlesc", array($wantusername, $wantpasshash, $secret, $editsecret, $pron, $CACHEARRAY['default_notifs'], $CACHEARRAY['default_emailnotifs'], $gender, $country, $icq, $msn, $aim, $yahoo, $skype, $mirc, $website, strtolower($email), $status))).
...
send_notifs('users');
safe_redirect("ok.php?type=". (!$users?"sysop":("signup&email=" . urlencode($email))));
