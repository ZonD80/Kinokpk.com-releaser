...
print("<table border=1 width='100%' ellspacing=0 cellpadding=2><form action=\"nowarn.php\" method=post>\n");
...
for ($i = 1; $i <= $num; $i++)
{
	...
	$last_access = get_elapsed_time($arr['last_access'])." {$tracker_lang['ago']}";
