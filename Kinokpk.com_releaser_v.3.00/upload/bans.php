...
if (is_valid_id($_GET['remove']))
{
	...
	$CACHE->clearGroupCache("bans");
	safe_redirect("bans.php",0);
	die();
}
...
else
{
	...
	while ($arr = mysql_fetch_assoc($res))
	{
	  ...
	  "<td  class=\"row1\" align=\"center\"><a href='userdetails.php?id=$arr[user]'>".get_user_class_color($arr['class'],$arr['username'])."</td>".
 	    "<td  class=\"row1\" align=\"center\"><a href=\"bans.php?remove=$arr[id]\">D</a></td></tr>\n");
	}
	print('</table>');
}
