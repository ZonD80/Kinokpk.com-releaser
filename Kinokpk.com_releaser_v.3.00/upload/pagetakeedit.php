...
if (isset($_POST['delete'])) {
	...
	if ((get_user_class() < UC_MODERATOR) && ($row['owner']<>$CURUSER['id'])) stderr($tracker_lang['error'],$tracker_lang['access_denied']);
	...
	stderr($tracker_lang['success'],'Страница успешно удалена <a href="pagebrowse.php">К списку страниц</a>','success');
}
