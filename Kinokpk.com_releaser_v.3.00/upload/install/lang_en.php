...
$lang['hello'] = "<p>Welcome to Kinokpk.com releaser 3.00 installer. Follow the instructions and <font color=\"red\">be careful</font> with general settings</p>";
$lang['agree'] = '<div align="center">You mast to be agreed with GNU GPLv3:</div>';
...
$lang['fail_notice'] = '<h3>If one or more values have <font color="red">red</font> status, it\'s recommended to fix it. If not, successful operating of Kinokpk.com releaser 3.00 doesn\'t guaranteed</h3><hr/>';
...
$lang['main_settings'] = '<h1 align="center"><font color="red">Warning! Read and modify configuration carefuly</font></h1><hr />';

$lang['settings_saved'] = 'Settings saved ';
$lang['settings_notice'] = '<p>You configured only general settings of Kinokpk.com releaser 3.00, after setup you can configure cron, retracker etc, all settings in http://your_site/admincp.php</p>';
$lang['install_complete'] = '<p>Congratulations! Installation of Kinokpk.com releaser 3.00 finished, you can view your site.</p>';
...
$lang['cookie_secret'] = 'Secret of cookies';
?>