...
$lang['hello'] = "<p>Добро пожаловать в мастер установки Kinokpk.com releaser 3.00. Следуйте инстукциям и <font color=\"red\">будьте внимательны</font> при настройке начальных параметров</p>";
...
$lang['fail_notice'] = '<h3>Если хоть одно из значений отображается <font color="red">красным</font>, рекомендуется исправить его. В противном случае правильное функционирование Kinokpk.com releaser 3.00 не гарантируется</h3><hr/>';
...
$lang['main_settings'] = '<h1 align="center"><font color="red">Внимание!!! Внимательно отнеситесь к этим настройкам</font></h1><hr />';

$lang['settings_saved'] = 'Настройки сохранены ';
$lang['settings_notice'] = '<p>Вы настроили только основную часть Kinokpk.com releaser 3.00, после процесса установки вы можете также настроить фунции cron, ретрекера и т.д., все настроики доступны из http://ваш_сайт/admincp.php</p>';
...
$lang['cookie_secret'] = 'Секрет cookies';
?>