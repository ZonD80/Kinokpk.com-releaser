...
dbconn();
stdhead("ЧаВо сайта {$CACHEARRAY['sitename']}");
begin_frame("ЧаВо сайта TorrentsBook.com ");
end_frame();
...
if (isset($faq_categ)) {
		...
		if ($faq_categ[$id][flag] == "1") {
			...
			if (array_key_exists("items", $faq_categ[$id])) {
				foreach ($faq_categ[$id][items] as $id2 => $temp) {
					...
					print("<li><a href=\"javascript: jQuery.facebox({div:'#box".$id2."'});\">". $faq_categ[$id][items][$id2][question] ."</a><img src=\"pic/updated.png\" alt=\"Обновлено\" title=\"Обновлено\" align=\"absbottom\"></li>");
					//						print("<li><a href=\"faq.php#". $id2 ."\" class=\"altlink\">". $faq_categ[$id][items][$id2][question] ."</a> <img src=\"pic/updated.png\" alt=\"Обновлено\" title=\"Обновлено\" align=\"absbottom\"></li>\n");
					elseif ($faq_categ[$id][items][$id2][flag] == "3")
					print("<li><a href=\"javascript: jQuery.facebox({div:'#box".$id2."'});\">". $faq_categ[$id][items][$id2][question] ."</a><img src=\"pic/new.png\" alt=\"Новое\" title=\"Новое\" align=\"absbottom\"></li>");
					//						print("<li><a href=\"faq.php#". $id2 ."\" class=\"altlink\">". $faq_categ[$id][items][$id2][question] ."</a> <img src=\"pic/new.png\" alt=\"Новое\" title=\"Новое\" align=\"absbottom\"></li>\n");
				}
			}
			print("</ul>\n</li>\n</ul>\n<br />\n");
		}
	...
	foreach ($faq_categ as $id => $temp) {
		if ($faq_categ[$id][flag] == "1") {
			//			$frame = $faq_categ[$id][title] ." - <a href=\"faq.php#\">Наверх</a>";
			//			begin_frame($frame);
