...
<table border="1" cellspacing="0" cellpadding="5">
<tr><td class="colhead" colspan="2"><?print $tracker_lang['upload_torrent'].(($descrtype == 1)?' [<a href="javascript:kinopoiskparser(\'parser\');">Заполнить форму, используя данные Kinopoisk.ru</a>]':'')?></td></tr>
<?
