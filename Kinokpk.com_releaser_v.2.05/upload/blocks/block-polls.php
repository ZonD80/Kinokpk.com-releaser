...
if ($CURUSER) {
    ...
    $id = @mysql_result($id,0);
      ...
      if (!$id) {$content .="<h1>Нет опросов!</h1>"; } else {
...
//      print($vote['vid'].$vote['username'].$vote['userclass'].$vote['userid'].",");
 ...
 $content .="<tr><td width=\"250px\">";
  ...
  $content .="</td><td><img src=\"./themes/$ss_uri/images/bar_left.gif\"><img src=\"./themes/$ss_uri/images/bar.gif\" height=\"12\" width=\"".$percentpervote*$votecount[$vsid]."%\"><img src=\"./themes/$ss_uri/images/bar_right.gif\">$percent%, голосов: ".$votecount[$vsid]."</td></tr>";
}
  ...
  $content .='<td align="center">Всего голосов: '.$tvotes.' [<a href="polloverview.php?id='.$id.'"><b>Подробнее</b></a>] [<a href="pollsarchive.php"><b>Архив опросов</b></a>]</td></tr>';
