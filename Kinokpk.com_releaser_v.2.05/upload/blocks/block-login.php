...
if ($CURUSER)  $content = "<a class=\"menu\" href=\"my.php\">&nbsp;Настройки аккаунта</a>"
           ...
           ."<a class=\"menu\" href=\"mywarned.php\">&nbsp;Мои предупреждения</a>"
           ...
           ."<a class=\"menu\" href=\"message.php\">&nbsp;".$tracker_lang['inbox']." ЛС</a>"
           ."<a class=\"menu\" href=\"message.php?action=viewmailbox&box=-1\">&nbsp;".$tracker_lang['outbox']." ЛС</a>"
           ...
           ."<a class=\"menu\" href=\"$FORUMURL/index.php\">&nbsp;".$tracker_lang['forum']." $FORUMNAME</a>"
		       ."<a class=\"menu\" href=\"testport.php\">&nbsp;Проверить NAT</a>"
...
Вы можете использовать логин и пароль форума $FORUMNAME для авторизации.<br /><hr><br />
