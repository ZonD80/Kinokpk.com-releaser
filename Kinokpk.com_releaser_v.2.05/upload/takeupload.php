...
$topicfooter .= "<tr><td valign=\"top\"><b>".(($_POST['nofile'] != 'yes')?"Торрент $DEFAULTBASEURL:":"Релиз $DEFAULTBASEURL:")."</b></td><td><div align=\"center\">[<span style=\"color:#FF0000\"><a href=\"$DEFAULTBASEURL/details.php?id=".$id."&hit=1\">Посмотреть этот фильм на $DEFAULTBASEURL</a></span>]</div></td></tr></table>";
