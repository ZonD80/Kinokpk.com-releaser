<?php
require_once 'classes/cache/cacheDriver.interface.php';
...
class Cache
{
  ...
  */
  	public function modificationTime($groupName, $identifier){
			...
			return $drv->modificationTime($groupName, $idetnifier);
				return false;
			}
	...
	public function get($groupName, $identifier, $lifeTime = 0, $driver = NULL)
	{
		...
		//	if(!$drv->exists($groupName, $identifier)) return false;
			if($drv->modificationTime($groupName, $idetnifier) < $lifeTime){
