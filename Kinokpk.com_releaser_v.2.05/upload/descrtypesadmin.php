...
elseif (!isset($_GET['action']) && ($_GET['class'] == 'type')) {
  ...
  print('<table width="100%" border="1"><tr><td class="colhead">ID</td><td class="colhead">Название</td><td class="colhead">ID Категории</td><td class="colhead">Ред/Уд</td></tr>');
...
$s .= "</select>\n";
  print("<table width=\"100%\"><form action=\"?class=type&action=saveadd\" enctype=\"multipart/form-data\" name=\"savearray\" method=\"post\"><tr><td class=\"colhead\">Название типа контента</td></tr><tr><td><input type=\"text\" name=\"type\" size=\"80\"></td></tr><tr><td class=\"colhead\">Категория:$s</td></tr></table>
...
$s .= "</select>\n";
  ...
  print("<table width=\"100%\"><form name=\"save\" enctype=\"multipart/form-data\" action=\"?class=type&action=saveedit\" method=\"post\"><tr><td class=\"colhead\">Название типа контента</td></tr><tr><td><input type=\"text\" name=\"type\" size=\"80\" value=\"$type\"></td></tr><tr><td class=\"colhead\">Категория:$s</table>
