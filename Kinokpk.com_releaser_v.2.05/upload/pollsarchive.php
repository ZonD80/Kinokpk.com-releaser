...
//      print($vote['vid'].$vote['username'].$vote['userclass'].$vote['userid'].",");
 ...
 foreach ($sidcount as $sidkey => $vsid){
  ...
  print("</td><td><img src=\"./themes/$ss_uri/images/bar_left.gif\"><img src=\"./themes/$ss_uri/images/bar.gif\" height=\"12\" width=\"".$percentpervote*$votecount[$vsid]."%\"><img src=\"./themes/$ss_uri/images/bar_right.gif\">$percent%, голосов: ".$votecount[$vsid]."<br/>".((!$usercode[$vsid])?"Никто не голосовал":$usercode[$vsid])."</td></tr>");
}
