...
$buffer = "";
$result = mysql_query("SELECT tid, posts, title, icon_id, description, starter_name, last_poster_name, views FROM ".$fprefix."topics WHERE (forum_id NOT IN (1)) ORDER BY last_post DESC LIMIT 0, 5");
