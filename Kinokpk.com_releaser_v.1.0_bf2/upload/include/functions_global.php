...
<div align="center"><a href="javascript:openstamp()"><b>Штампы</b></a> (откроются в новом окошке)</div>
<?
}
...
"<div class=\"news-wrap\"><div class=\"news-head folded clickable\"><table width=100% border=0 cellspacing=0 cellpadding=0><tr><td class=bottom width=50%>Скрытый текст (большой и неудобный для отображения)</td></tr></table></div><div class=\"news-body\">\\1</div></div>", $s);

    //[spoiler=name]Text[/spoiler]
$s = preg_replace("/\[spoiler=\s*((\s|.)+?)\s*\]((\s|.)+?)\[\/spoiler\]/i",
"<div style=\"position: static;\" class=\"news-wrap\"><div class=\"news-head folded clickable\">\\1</div><div style=\"display: none;\" class=\"news-body\"><div></div>\\3<div class=\"clear\"></div></div></div><div class=\"clear\"></div>", $s);
