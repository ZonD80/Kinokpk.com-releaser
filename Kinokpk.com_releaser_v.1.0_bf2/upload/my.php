...
$comment_type = mysql_query("SELECT comment_type FROM users WHERE id=".$CURUSER['id']);
$comment_type = mysql_result($comment_type,0);
...
tr("Загрузить аватар", "<a href=avatarup.php>Кликните сюда для загрузки</a>", 1);
...
tr($tracker_lang['my_userbar'], "<img src=\"torrentbar/bar.php?id=".$CURUSER["id"].".png\" border=\"0\"><br />".$tracker_lang['my_userbar_descr'].":<br /><input type=\"text\" size=65 value=\"[url=$DEFAULTBASEURL][img]$DEFAULTBASEURL/torrentbar/bar.php?id=".$CURUSER["id"].".png[/img][/url]\" readonly />",1);
