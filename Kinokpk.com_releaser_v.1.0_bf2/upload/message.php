...
for (var i=0; i < oForm[cbName].length; i++) oForm[cbName][i].checked = checked;
        ...
        <input type="submit" name="unarchive" title="Разрхивировать" value="Разархивировать" onClick="return confirm('Разархивировать выбранные сообщения? (они будут удалены системой автоматически)')"></form>
