...
Если вы подтверждаете этот запрос, перейдите по следующей ссылке:
	...
	{$REL_CONFIG['defaultbaseurl']}/{$REL_SEO->make_link('recover','confirm','','id',$arr["id"],'secret',$hash)}
...
Вы можете войти на сайт тут: {$REL_CONFIG['defaultbaseurl']}/{$REL_SEO->make_link('login')}
