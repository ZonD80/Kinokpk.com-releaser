...
<form name="upload" action="'.$REL_SEO->make_link('pageupload').'" method="GET">
...
<form name="upload" enctype="multipart/form-data"
	action="<?=$REL_SEO->make_link('pagetakeupload');?>" method="post"><input type="hidden"
...
<table border="1" cellspacing="0" cellpadding="5">
	...
	tr($REL_LANG->say_by_key('description'),textbbcode("descr"),1);
	...
	if (get_user_class() >= UC_MODERATOR) {
		...
		tr("Создатель - ".$REL_LANG->say_by_key('from_system'),"<input type=\"checkbox\" name=\"system\" value=\"1\">",1);
