...
воспользоваться формой <a href="<?=$REL_SEO->make_link('recover')?>">восстановления паролей</a></p>
<p>Ещё не зарегистрированы ? Вы можете <a href="<?=$REL_SEO->make_link('signup')?>">зарегистрироваться</a>
прямо сейчас!</p>
</div>
<?
