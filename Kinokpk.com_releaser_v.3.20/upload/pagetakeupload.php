...
if (!$descr) stderr($REL_LANG->say_by_key('error'),'Вы не ввели текст страницы');
...
stderr($REL_LANG->say_by_key('success'),"Добавлена страница".' <a href="'.$REL_SEO->make_link('pagedetails','id',$id).'">'.$REL_SEO->make_link('pagedetails','id',$id).'</a>','success');
