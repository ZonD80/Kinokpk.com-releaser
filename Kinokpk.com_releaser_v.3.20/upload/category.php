...
if(isset($_GET['added'])) {
	...
	stdmsg($REL_LANG->say_by_key('success'),$REL_LANG->say_by_key('add_new_category'));
	$REL_CACHE->clearGroupCache('trees');
	stdfoot();
	die();
}
...
if(isset($_GET['add'])) {
	...
	print("<tr><td colspan=\"2\"><div align='center'><input type='submit' value='{$REL_LANG->say_by_key('add_new_category')}'/></div></td></tr>");
	print("</table></form>");
	stdfoot();
	die();
}
