...
$result = sql_query("SELECT u.id, u.username, u.class FROM users AS u WHERE u.last_access > ".(time() - 300)." GROUP BY u.username ORDER BY u.class DESC");
...
$content .= "<tr valign='middle'>
            <td align='left' class='embedded' style='padding:5px; border: 1px solid #266C8A; background-color: #FFFFFF'>
            <b>В сети: </b><br />";
$content .= "<img src='pic/info/admin.gif' alt='Администраторы' align='middle' width='16' height='16' />&nbsp;<font color='red'>Админы: $staff</font><br />";
$content .= "<img src='pic/info/member.gif' alt='Пользователи' align='middle' width='16' height='16' />&nbsp;Пользователи: $users <br />";
$content .= "<img src='pic/info/guest.gif' alt='Гости' align='middle' width='16' height='16' />&nbsp;Гости: $guests <br />";
$content .= "<img src='pic/info/group.gif' alt='Всего' align='middle' width='16' height='16' />&nbsp;Всего: $total</td></tr></table>";
?>