...
{
	stdmsg($tracker_lang['error'], $tracker_lang['access_deined'], 'error');
	stdfoot();
	die();
}
...
if($per_list < $count){
	...
	while(list($spy_url, $user_id, $user_name, $user_class, $user_ip, $user_agent, $user_time) = mysql_fetch_array($spy_res)){
		...
		$slep = "<div class=\"news-wrap\"><div class=\"news-head folded clickable\"><table width=100% border=0 cellspacing=0 cellpadding=0><tr><td class=bottom width=50%><i>Открыть</i></td></tr></table></div><div class=\"news-body\">"
