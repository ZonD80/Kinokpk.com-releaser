...
foreach ($sidcount as $sidkey => $vsid){
	...
	print("</td><td><img src=\"./themes/$ss_uri/images/bar_left.gif\"><img src=\"./themes/$ss_uri/images/bar.gif\" height=\"12\" width=\"".round($percentpervote*$votecount[$vsid])."%\"><img src=\"./themes/$ss_uri/images/bar_right.gif\">$percent%, голосов: ".$votecount[$vsid].((!$usercode[$vsid])?"<br />Опрос приватный или никто не голосовал":"<br />".$usercode[$vsid])."</td></tr>");
}
