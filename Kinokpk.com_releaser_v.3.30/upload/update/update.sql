...
ALTER TABLE `orbital_blocks` 
	...
	CHANGE `bposition` `bposition` char(1)  COLLATE cp1251_general_ci NOT NULL after `content`, 
	CHANGE `weight` `weight` int(10)   NOT NULL DEFAULT '1' after `bposition`, 
	CHANGE `active` `active` int(1)   NOT NULL DEFAULT '1' after `weight`, 
	CHANGE `blockfile` `blockfile` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `active`, 
	CHANGE `view` `view` varchar(20)  COLLATE cp1251_general_ci NULL after `blockfile`, 
	CHANGE `expire` `expire` int(10)   NOT NULL DEFAULT '0' after `view`, 
	CHANGE `which` `which` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `expire`, 
...
CREATE TABLE `seorules`(
	...
	`parameter` varchar(255) COLLATE cp1251_general_ci NULL  , 
	`repl` varchar(255) COLLATE cp1251_general_ci NULL  , 
	`unset_params` varchar(255) COLLATE cp1251_general_ci NULL  , 
...
ALTER TABLE `torrents` 
	...
	CHANGE `modcomm` `modcomm` text  COLLATE cp1251_general_ci NOT NULL after `moderated`, 
...
ALTER TABLE `users` 
	...
	CHANGE `avatar` `avatar` varchar(100)  COLLATE cp1251_general_ci NOT NULL after `supportfor`, 
	CHANGE `icq` `icq` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `avatar`, 
	CHANGE `msn` `msn` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `icq`, 
	CHANGE `aim` `aim` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `msn`, 
	CHANGE `yahoo` `yahoo` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `aim`, 
	CHANGE `skype` `skype` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `yahoo`, 
	CHANGE `mirc` `mirc` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `skype`, 
	CHANGE `website` `website` varchar(50)  COLLATE cp1251_general_ci NOT NULL after `mirc`, 
	CHANGE `title` `title` varchar(30)  COLLATE cp1251_general_ci NOT NULL after `website`, 
	...
	CHANGE `emailnotifs` `emailnotifs` varchar(1000)  COLLATE cp1251_general_ci NOT NULL after `notifs`, 
	...
	CHANGE `dis_reason` `dis_reason` text  COLLATE cp1251_general_ci NOT NULL after `enabled`, 
	...
	CHANGE `passkey` `passkey` varchar(32)  COLLATE cp1251_general_ci NOT NULL after `birthday`, 
	CHANGE `language` `language` varchar(255)  COLLATE cp1251_general_ci NULL after `passkey`, 
	...
	CHANGE `passkey_ip` `passkey_ip` varchar(15)  COLLATE cp1251_general_ci NOT NULL after `invitedroot`, 
	CHANGE `num_warned` `num_warned` int(2)   NOT NULL DEFAULT '0' after `passkey_ip`, 
	CHANGE `status` `status` varchar(255)  COLLATE cp1251_general_ci NOT NULL after `num_warned`, 
